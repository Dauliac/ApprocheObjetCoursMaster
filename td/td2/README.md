...
* Coder une hierarchie de classes (couplage fort)
...
Oui, modififier une information peu ne pas suffir, il faudrait la modifier à plusieurs endroit pour obtenir un effet escompté.
...
Créer un autre objet et suprimer l'ancien.